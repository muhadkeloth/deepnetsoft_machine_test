...
const MenuList = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 px-4 py-20 md:px-28">
      <div className="w-full sm:w-1/3 border border-white rounded-2xl p-6 text-center order-1 sm:order-2 relative">
        <img
          src={logo}
          alt="Decorative"
      ...
      <div className="w-full sm:w-1/3 border border-white rounded-2xl p-6 text-center order-2 sm:order-1">
        <h1 className="text-xl font-bold text-main-clr  tracking-wide">CONNECT WITH US</h1>
      ...
      <div className="w-full sm:w-1/3 border border-white rounded-2xl p-6 text-center order-3">
      <h1 className="text-xl font-bold text-main-clr  tracking-wide">FIND US</h1>
